#!/usr/bin/env sh
# Universal installer for privacyshell. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/privacyshell.git"
echo "Installing privacyshell ..."
...
echo "Done. Run: privacyshell --help"
